...
import static com.knoldus.kafka.connect.connector.util.RandomLongHttpClient.httpClient;
import static com.knoldus.kafka.connect.connector.util.RandomLongSchemas.VALUE_SCHEMA;
...
public class RandomLongSourceTask extends SourceTask {
    ...
    public void start(Map<String, String> props) {
        ...
        apiUrl = randomLongSourceConnectorConfig.getString(RandomLongSourceConnectorConfig.API_URL_CONFIG);
        sleepInSeconds = randomLongSourceConnectorConfig.getInt(RandomLongSourceConnectorConfig.SLEEP_CONFIG);
        topic = randomLongSourceConnectorConfig.getString(RandomLongSourceConnectorConfig.TOPIC_CONFIG);
    }
